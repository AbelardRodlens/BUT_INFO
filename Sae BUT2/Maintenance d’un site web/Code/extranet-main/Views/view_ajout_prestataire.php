...
?>
    <div class="main-container">
        <div class="ajt prest container">
            <h1>Ajout Prestataire</h1>
            <form action="?controller=<?php echo $_GET['controller']; ?>&action=<?php if(isset($_GET['id'])): echo 'ajout_prestataire_dans_mission&id=' . $_GET['id']; else: echo 'ajout_prestataire'; endif;?>" method="post">
