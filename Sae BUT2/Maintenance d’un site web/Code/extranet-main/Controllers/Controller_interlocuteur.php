...
class Controller_interlocuteur extends Controller
{
    ...
    public function action_dashboard()
    {
        ...
        if (isset($_SESSION['id'])) {
            ...
            $headerDashboard = ['Nom projet/société', 'Date', 'Préstataire assigné','Status', 'Bon de livraison'];
    ...
    {
        return [['link' => '?controller=interlocuteur&action=dashboard', 'name' => 'Mes prestataires', 'icon' => '<i class="fa-solid fa-user"></i>']];
    }
